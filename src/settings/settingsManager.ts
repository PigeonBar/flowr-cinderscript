...
export class SettingsManager {
   ...
   */
  getDefault(key: BooleanSettingsKey): boolean;
  getDefault(key: NumberSettingsKey): number;
  getDefault(key: ColourSettingsKey): string;
  getDefault(key: RaritySettingsKey): Rarity;
  getDefault(key: KeybindSettingsKey): string;
  getDefault(key: SettingsKey): any {
